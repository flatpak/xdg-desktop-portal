...
#if !defined(HAVE_NAME_TO_HANDLE_AT) && defined(__NR_name_to_handle_at)
...
struct inline_file_handle {
        unsigned int handle_bytes;
        int handle_type;
        unsigned char f_handle[0];
};
#define file_handle inline_file_handle

static inline int
inline_name_to_handle_at (int                 fd,
                          const char         *name,
...
#define name_to_handle_at inline_name_to_handle_at
