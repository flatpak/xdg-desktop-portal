...
static GOptionEntry entries[] = {
  ...
  { "path", 0, 0, G_OPTION_ARG_FILENAME, &opt_path, "Read icon data from given file path", "PATH" },
  { "fd", 0, 0, G_OPTION_ARG_INT, &opt_fd, "Read icon data from given file descriptor", "FD" },
  { NULL }
};
