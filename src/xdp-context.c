                    ...
                    gpointer                user_data)
{
  ...
  flags = GPOINTER_TO_UINT (g_object_get_data (G_OBJECT (interface),
                                               "-xdp-skeleton-export-flags"));
  ...
  if ((flags & XDP_CONTEXT_EXPORT_FLAGS_NO_ENTITLEMENT) == 0 &&
                                    ...
                                    XdpContextExportFlags   flags)
{
  ...
  g_object_set_data (G_OBJECT (skeleton), "-xdp-skeleton-export-flags",
