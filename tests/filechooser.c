...
test_open_file_libportal (void)
{
  ...
  got_info = FALSE;
  xdp_portal_open_file (portal, NULL, "test", FALSE, FALSE, NULL, NULL, NULL, open_file_cb, keyfile);
...
test_open_file_close (void)
{
  ...
  got_info = FALSE;
  xdp_portal_open_file (portal, NULL, "test", FALSE, FALSE, NULL, NULL, cancellable, open_file_cb, keyfile);
...
test_save_file_libportal (void)
{
  ...
  got_info = FALSE;
  xdp_portal_save_file (portal, NULL, "test", FALSE, "test_file.txt", NULL, NULL, NULL, NULL, NULL, save_file_cb, keyfile);
...
test_save_file_close (void)
{
  ...
  got_info = FALSE;
  xdp_portal_save_file (portal, NULL, "test", FALSE, "test_file.txt", NULL, NULL, NULL, NULL, cancellable, save_file_cb, keyfile);
