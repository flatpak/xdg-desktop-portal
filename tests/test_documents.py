...
def path_from_null_term_bytes(bytes):
    path_bytes = bytes.split(b"\x00")[0]
...
def export_file_named(documents_intf, folder_path, name, unique=False):
    ...
    # why does this need to be NULL terminated? otherwise:
    # dbus.exceptions.DBusException: org.freedesktop.portal.Error.InvalidArgument
    name_nt = name.encode("utf8") + b"\x00"
