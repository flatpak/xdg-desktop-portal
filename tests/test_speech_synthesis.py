...
class TestSpeechSynthesis:
    ...
    def listen_to_synth_signals(self, dbus_con):
        ...
        dbus_con.add_signal_receiver(
            signal_reciever,
            dbus_interface=xdp.portal_interface_name("SpeechSynthesis"),
    ...
    def test_version(self, portals, dbus_con):
        xdp.check_version(dbus_con, "SpeechSynthesis", 1)
    ...
    def test_session_get_providers(self, portals, dbus_con, dbus_con_sys):
        ...
        synth_intf = xdp.get_portal_iface(dbus_con, "SpeechSynthesis")
